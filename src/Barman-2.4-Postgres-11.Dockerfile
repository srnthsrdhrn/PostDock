...
#RUN install_deb_pkg "http://atalia.postgresql.org/morgue/b/barman/barman_2.4-1.pgdg90%2B1_all.deb"
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/barman_2.3-2.pgdg17.04%2B1_all.deb"
