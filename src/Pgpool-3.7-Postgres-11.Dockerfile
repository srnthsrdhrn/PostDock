...
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/libpgpool0_3.6.7-1.pgdg17.04%2B1_amd64.deb"
#RUN install_deb_pkg "http://atalia.postgresql.org/morgue/p/pgpool2/libpgpool0_3.7.5-2.pgdg90+1_amd64.deb" "libpgpool0"
RUN install_deb_pkg "http://atalia.postgresql.org/morgue/pgpool2_3.6.7-1.pgdg17.04%2B1_amd64.deb" "pgpool2"
